...
export class ProductPreview extends Component<IProduct> implements IProductPreview {
    ...
    render(data?: IProduct, isInBasket: boolean = false): HTMLElement {     
        ...
        this.button.textContent = this.blockProductSale(this.button, data, isInBasket);
